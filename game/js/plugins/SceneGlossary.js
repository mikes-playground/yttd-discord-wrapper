...
(function() {
    ...
    Window_MenuCommand.prototype.addOriginalCommands = function() {
        ...
        for (var i = 0; i < paramCommandNamesMax; i++) {
            if (Scene_Menu.isVisibleGlossaryCommand(i)) {
                this.addCommand(CTE.getString("GlossaryCommand", paramCommandNames[i]), 'glossary' + String(i), this.isGlossaryEnabled(i));
            }
        }
    };
    ...
    Scene_Glossary.prototype.updateHelp = function(helpText) {
        if (paramHelpText) {
            this._helpWindow.setText(CTE.getString("GlossaryHelp", helpText));
        } else {
    ...
    Window_Glossary.prototype.getDescription = function(index) {
        return CTE.getString("ItemDesc" + this._itemData.id, this.getMetaContents(['説明', 'Description'], index));
    };
    ...
    Window_Glossary.prototype.updateArrows = function() {
        this.downArrowVisible = false; //this.canMoveLeft();
        this.upArrowVisible   = false; // this.canMoveRight();
    };

...
_TempLog =$gameVariables.value( parseInt(_TempLog), true );
...
//前半はデフォルトのソースをコピペ。
    ...
    text = text.replace(/\x1bV\[(\d+)\]/gi, function() {
        return $gameVariables.value(parseInt(arguments[1]), true);
    }.bind(this));
...
//　　　　　　　　　　ここ▼　　　　　　　　　　　　とここ▼
an_BackLogNowText[0]=CTE.getString("BacklogPageNumber", "##Log Page {0}##").replace(/\{0\}/g, Number(nBackLogPage));
var j=1;
